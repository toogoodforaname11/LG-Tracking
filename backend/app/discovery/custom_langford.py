"""Custom scraper for City of Langford.

Source URL: https://langford.ca/city-hall/
Langford publishes council agendas and minutes through their city hall page.
"""
...
class LangfordScraper(BaseScraper):
    """Scraper for City of Langford council agendas and minutes."""

    async def discover(self) -> list[DiscoveredItem]:
        """Discover meeting documents from the Langford city hall page."""
        ...
        try:
            ...
            # Find agenda/minutes subpages from city hall landing
            ...
            logger.error("Langford scrape failed: %s", e)

        logger.info("Langford discovery: %d items found", len(items))
        return items
    ...
    def _find_meeting_links(self, soup: BeautifulSoup) -> list[str]:
        ...
        for link in soup.find_all("a", href=True):
            ...
            if any(k in text for k in [
                ...
                "council schedule", "public hearing",
            ]):
